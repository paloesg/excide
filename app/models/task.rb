class Task < ApplicationRecord
  ...
  enum task_type: { instructions: 0, upload_file: 1, approval: 2, download_file: 3, visit_link: 4, upload_photo: 5, enter_data: 6, upload_multiple_files: 7, send_xero_email: 8, create_invoice_payable: 9, xero_send_invoice: 10, create_invoice_receivable: 11, coding_invoice: 12}
