...
class User < ApplicationRecord
  ...
  belongs_to :company
  belongs_to :active_outlet, :class_name => "Outlet", :foreign_key => "active_outlet_id"
  ...
  has_many :folders
  has_many :outlets_users, dependent: :destroy
  ...
  def motif_roles(company)
    self.roles.find_by(resource_id: company.id, resource_type: "Company", name: ["franchisor", "franchisee_owner"])
  end
end
