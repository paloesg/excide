...
$(document).ready(function () {
  ...
  $("#client_id,#template_id").on('change', function() {
    if ($("#client_id").val() && $("#template_id").val()) {
      $("#uploadToXero").collapse();
    }
  })

  // $("#uploadToXero").length 'To check #uploadToXero is exists'
  if ($("#uploadToXero").length) {
    ...
    var documentUpload = new Dropzone('#uploadToXero', { timeout: 0, renameFilename: cleanFilename });
