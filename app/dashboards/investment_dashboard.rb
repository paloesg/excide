...
class InvestmentDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    investor: Field::BelongsTo.with_options(class_name: "Company"),
    startup: Field::BelongsTo.with_options(class_name: "Company"),
    id: Field::String.with_options(searchable: false),
    investor_id: Field::String.with_options(searchable: false),
    startup_id: Field::String.with_options(searchable: false),
