class ApplicationController < ActionController::Base
  ...
  def after_sign_in_path_for(resource)
    if current_user.has_role?(:entrepreneur, current_user.company) or current_user.has_role?(:franchisor_free, current_user.company)
  ...
  def authenticate_product
    product = self.class.module_parent.to_s.downcase.split("::")[0]
