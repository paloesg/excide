class Symphony::InvoicesController < ApplicationController
  ...
  def invoice_params
    params.require(:invoice).permit(:invoice_date, :due_date, :workflow_id, :line_amount_types, lineitems_attributes: [:description, :quantity, :price, :account, :tax, :_destroy])
  end
