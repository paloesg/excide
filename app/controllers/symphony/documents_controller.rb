class Symphony::DocumentsController < ApplicationController
  ...
  def document_params
    params.require(:document).permit(:filename, :remarks, :company_id, :date_signed, :date_uploaded, :file_url, :workflow_id, :document_template_id, :raw_file, converted_image: [])
  end
