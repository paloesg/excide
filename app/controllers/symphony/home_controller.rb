class Symphony::HomeController < ApplicationController
  ...
  def index
    ...
    @template_pro = @templates.joins(sections: :tasks).where(tasks: {task_type: ["pro_create_invoice_payable", "pro_xero_send_invoice", "pro_create_invoice_receivable", "pro_coding_invoice"]})
