class GenerateRecurringWorkflow
  ...
  def generate_workflow
    Workflow.create(user_id: @recurring_workflow.user.id, company_id: @recurring_workflow.template.company.id, template_id: @recurring_workflow.template.id, recurring_workflow_id: @recurring_workflow.id, deadline: Date.current + 1.week)
  end
