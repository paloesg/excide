...
RSpec.describe Conductor::AllocationsController, type: :controller do
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:allocation => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested allocation" do
        allocation = Allocation.create! valid_attributes
        put :update, {:id => allocation.to_param, :allocation => new_attributes}, valid_session
        allocation.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        allocation = Allocation.create! valid_attributes
        put :update, {:id => allocation.to_param, :allocation => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
