...
RSpec.describe Conductor::AvailabilitiesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      availability = Availability.create! valid_attributes
      get :show, {:id => availability.to_param}, valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      availability = Availability.create! valid_attributes
      get :edit, {:id => availability.to_param}, valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:availability => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested availability" do
        availability = Availability.create! valid_attributes
        put :update, {:id => availability.to_param, :availability => new_attributes}, valid_session
        availability.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        availability = Availability.create! valid_attributes
        put :update, {:id => availability.to_param, :availability => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
